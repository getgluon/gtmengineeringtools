  ...
  "outreach": {
    "cold_emails": [
      ...
      },
      {
        "variant": "Insight-Led",
        "subject": "Subject line",
        "body": "Full email referencing a specific insight or news item."
      },
      {
    ...
    "linkedin_connection": "Short personalized connection request under 300 characters.",
    "linkedin_inmail": {
      "subject": "InMail subject line",
      "body": "Full InMail message."
    },
    "talking_points": [
      {
...
export default async function handler(req, res) {
  ...
  try {
    const result = await runResearch(companyInput);
